...
class OwnerProductView extends StatefulWidget {
  const OwnerProductView({Key? key}) : super(key: key);

  @override
  State<OwnerProductView> createState() => _OwnerProductViewState();
}

class _OwnerProductViewState extends State<OwnerProductView>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  int selectedIndex = 0;
  int threeTabIndex = 0;
  int catIndex = 0;
  set intValue(int value) => setState(() => threeTabIndex = value);
                ...
                children: [
                  Container(
                    ...
                    child: CustomThreeTab(
                      size: size,
                      firstTabText: 'Product',
                      secondTabText: 'Services',
                      thirdTabText: 'Promotions',
